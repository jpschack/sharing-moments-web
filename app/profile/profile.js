angular.module('profileApp').controller('ProfileCtrl', function($scope, $rootScope, userData, userPhotoData, userEventData, $account, $user, $uibModal, $modalPhotoViewSlider) {
    ...
    $scope.userImageAction = function () {
        ...
        profileImageActionsModal.result.then(function () {}, function () {});
    };
    ...
    $scope.showUserEvents = function () {
        ...
        profileUserEventsModal.result.then(function () {}, function () {});
    };
...
angular.module('profileApp').controller('ProfileImageCtrl', function($scope, $rootScope, $uibModalInstance, $uibModal, $account, $fileReader) {
    $scope.uploadFile = function (event) {
        ...
        if ($scope.sizeValid && $scope.typeValid) {
            ...
            profileImageAlertModal.result.then(function () {}, function () {});
        }
    };
